        ...
        <Container>
          <Row className="aligh-items-center">
            <Col xs={12} md={6} xl={7}>
                  ...
                  <h1>{`Hi! I'm Abdullah`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "VIDEO EDITOR", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
